              ...
              <div className="card p-6 border-l-4 border-primary">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-foreground">₹{data.total_revenue}</p>
                  </div>
              ...
              <div className="card p-6 border-l-4 border-success">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-success">₹{data.today_revenue}</p>
                  </div>
              ...
              <div className="card p-6 border-l-4 border-warning">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-warning">{data.pending_invoices}</p>
                  </div>
              ...
              <div className="card p-6 border-l-4 border-accent">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-3xl font-bold text-accent">{data.completed_appointments}</p>
                  </div>
            ...
            <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="card p-6">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-lg font-semibold text-foreground">{data.top_doctor.name}</p>
                    <p className="text-sm text-secondary">
                      {data.top_doctor.appointments_count} appointments completed
                    </p>
                  </div>
                </div>
              </div>
